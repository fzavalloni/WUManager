    ...
    public class ProgressBar : System.Windows.Forms.UserControl
    {
        ...
        public int Value
        {
            ...
            set
            {
                ...
                ValueChanged?.Invoke(this, new EventArgs()); this.Invalidate();
            }
        }
        ...
        public int MaxValue
        {
            ...
            set
            {
                ...
                if (Value < MaxValue) { mGlowAnimation.Start(); }
                MaxChanged?.Invoke(this, new System.EventArgs()); this.Invalidate();
            }
        }
        ...
        public int MinValue
        {
            ...
            set
            {
                ...
                MinChanged?.Invoke(this, new System.EventArgs()); this.Invalidate();
            }
        }
        ...
        private void DrawBar(Graphics g)
        {
            ...
            {
                Width = (int)(Value * 1.0F / (MaxValue - MinValue) * this.Width)
            };
        ...
        private void DrawBarShadows(Graphics g)
        {
            ...
            {
                Colors = new Color[] { Color.Transparent, Color.FromArgb(40, 0, 0, 0), Color.Transparent },
            ...
            {
                X = (int)(Value * 1.0F / (MaxValue - MinValue) * this.Width) - 14
            };
        ...
        private void DrawGlow(Graphics g)
        {
            ...
            {
                Colors = new Color[] { Color.Transparent, this.GlowColor, this.GlowColor, Color.Transparent },
                Positions = new float[] { 0.0F, 0.5F, 0.6F, 1.0F }
            };
